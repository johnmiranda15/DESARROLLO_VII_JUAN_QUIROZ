...
$misPeliculas = "El señor de los anillos-Interstellar-John Wick-Secretariat-Invicto";
//Intenta usar explode() con diferentes delimitadores y límites.
//$arrayPeliculas = explode("-", $misPeliculas);
//$arrayPeliculas = explode(" ", $misPeliculas);
$arrayPeliculas = explode(",", $misPeliculas);
//$arrayPeliculas = explode("-", $misPeliculas, 3);
//$arrayPeliculas = explode(" ", $misPeliculas);
