...
$misComidas = ["arroz con porotos", "lasagna", "pizza"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["hamburguesa", "sushi", "tacos"]; // Reemplaza con las comidas favoritas de tu amigo
