...
$misAmigos = ["Manuel Beker", "Regulo Barrios", "Clovis Avila"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Isac Pomares", "Luis Morales"); // Reemplaza las comillas vacías con los nombres de tus amigos
//array_push asociativo
$misAmigosAsociativo = [
    "amigo1" => "Manuel Beker",
    "amigo2" => "Regulo Barrios",
    "amigo3" => "Clovis Avila"
];
array_push($misAmigosAsociativo, "Isac Pomares", "Luis Morales");
