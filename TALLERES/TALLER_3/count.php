...
$misCanciones = ["Into Eternity","Breathe","Deus ex Machina", "Stargazer", "The rules of destiny"]; // Reemplaza esto con tu array de canciones
...
// count() con array multidimensional
$numGeneros = count($playlist);
$totalCanciones = 0;
