...
$tuNombre = "JUAN DE DIOS QUIROZ MIRANDA";
...
$test1 = compararSinMayusculas("Casa", "casa"); // true
$test2 = compararSinMayusculas("Sol", "soles"); // false
$test3 = compararSinMayusculas("Árbol", "ÁRBOL"); // true

echo "'Casa' y 'casa' iguales? " . ($test1 ? "Sí" : "No") . "</br>";
echo "'Sol' y 'soles' iguales? " . ($test2 ? "Sí" : "No") . "</br>";
echo "'Árbol' y 'ÁRBOL' iguales? " . ($test3 ? "Sí" : "No") . "</br>";
...
$ejemplo1 = "¡BIENVENIDO!";
echo strtolower($ejemplo1) . "</br>"; // Resultado: ¡bienvenido!

$ejemplo2 = "PrObAnDo CaDeNa";
echo strtolower($ejemplo2) . "</br>"; // Resultado: probando cadena
...
$fraseOriginal2 = "eSTO ES oTRA Prueba";
$fraseModificada2 = primerLetraMayuscula($fraseOriginal2);
echo "</br>Frase original: $fraseOriginal2</br>";
echo "Frase modificada (Primera letra mayúscula): $fraseModificada2</br>";
?>